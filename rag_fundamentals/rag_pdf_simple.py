...
class SimpleModelSelector:
    ...
    llm_models = {"ollama": "Llama3.1", "openai": "GPT-4"}
...
class SimpleRAGSystem:
    ...
    def __init__(self, embedding_model="qwen", llm_model="llama3.1"):
    ...
    def setup_embedding_function(self):
        ...
        try:
            if self.embedding_model == "openai":
                ...
                # For Qwen3 embeddings via Ollama
                self.embedding_fn = embedding_functions.OpenAIEmbeddingFunction(
                    api_key="ollama",
    ...
    def generate_response(self, query, context):
        ...
        try:
            ...
            response = self.llm.chat.completions.create(
                model="gpt-4o-mini" if self.llm_model == "openai" else "llama3.1",
                messages=[
